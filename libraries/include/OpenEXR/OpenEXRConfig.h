...
/* config/OpenEXRConfig.h.in.  Generated from configure.ac by autoheader.  */

/* define if complete iomanip support in C++ standard library */
...
/* define for large stack support */
#define HAVE_LARGE_STACK 1

/* Define to 1 if you have the <limits.h> header file. */
#define HAVE_LIMITS_H 1

/* define for procfs support */
#define HAVE_LINUX_PROCFS 1

/* Define to 1 if you have the <memory.h> header file. */
#define HAVE_MEMORY_H 1

/* define for posix semaphores */
