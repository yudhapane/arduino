...
#define SBK_PHONON_QHASH_QBYTEARRAY_QVARIANT_IDX                     6 // const QHash<QByteArray, QVariant > &
#define SBK_PHONON_QLIST_PHONON_OBJECTDESCRIPTION_PHONON_EFFECTTYPE__IDX 7 // const QList<Phonon::ObjectDescription<Phonon::EffectType > > &
#define SBK_PHONON_QMAP_INT_QVARIANT_IDX                             8 // QMap<int, QVariant >
#define SBK_PHONON_QHASH_INT_QBYTEARRAY_IDX                          9 // const QHash<int, QByteArray > &
#define SBK_PHONON_QLIST_INT_IDX                                     10 // QList<int >
#define SBK_PHONON_QLIST_PHONON_OBJECTDESCRIPTION_PHONON_AUDIOOUTPUTDEVICETYPE__IDX 11 // const QList<Phonon::ObjectDescription<Phonon::AudioOutputDeviceType > > &
